...
http_archive(
    ...
    sha256 = "06d1bb36cdcfa9f79316f48f378614c6162b645ac36e8db63417364b461a2933",
    strip_prefix = "bazel-toolchains-2.2.1",
    url = "https://github.com/bazelbuild/bazel-toolchains/archive/2.2.1.tar.gz",
)
